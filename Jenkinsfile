...
echo "git job name is : ${env.JOB_NAME} "
...
scp -o StrictHostKeyChecking=no target/demo.war ec2-user@13.201.4.156:/opt/apache-tomcat-9.0.102/webapps/
	}
}
}//try
catch(e) {
